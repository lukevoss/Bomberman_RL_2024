...
class TestingAddOwnEvents(unittest.TestCase):
    ...
    def test_survived_step_event(self):
        result = add_own_events_q_learning(self.old_game_state, 'UP', self.events_src,
    ...
    def test_won_round(self):
        ...
        # Won game
        result = add_own_events_q_learning(state, 'UP', self.events_src,
    ...
    def test_escaping(self):
        ...
        # Is escaping
        state["bombs"] = [((1, 1), 3)]
        result = add_own_events_q_learning(state, 'DOWN', self.events_src,
                                self.end_of_round, self.agent_coord_history, self.max_opponents_score)
        ...
        # Has ecaped
        result = add_own_events_q_learning(state, 'RIGHT', self.events_src,
                                self.end_of_round, self.agent_coord_history, self.max_opponents_score)
    ...
    def test_waited_necessarily(self):
        ...
        result = add_own_events_q_learning(state, 'WAIT', self.events_src,
                                self.end_of_round, self.agent_coord_history, self.max_opponents_score)
    ...
    def test_bomb_dropped(self):
        ...
        result = add_own_events_q_learning(state, 'BOMB', self.events_src,
                                self.end_of_round, self.agent_coord_history, self.max_opponents_score)
    ...
    def test_got_in_loop(self):
        ...
        result = add_own_events_q_learning(state, 'LEFT', self.events_src,
