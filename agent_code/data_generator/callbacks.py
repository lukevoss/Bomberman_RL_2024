...
The generated data samples consist of the normalized game state and the following expert action. 

Potential fix: rule based agent gets sometimes in a loop with other rule based agent, when running into each other
...
def act(self, game_state):
    """
    Rule based Agent to act as expert predictor
    """
