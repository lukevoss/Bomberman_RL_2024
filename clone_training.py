...
def main():
    ...
    train_dataset, validation_dataset = random_split(expert_dataset, [train_size, test_size])
    ...
    #scheduler = torch.optim.lr_scheduler.OneCycleLR(optimizer, max_lr = MAX_LR, epochs = NUM_EPOCHS, steps_per_epoch= len(train_loader), div_factor=5, final_div_factor=25 )
