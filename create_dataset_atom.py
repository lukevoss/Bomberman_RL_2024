...
def main():
    ...
    input_dir = "./agent_code/data_generator_atom/data"
    ...
    np.savez_compressed("./expert_data_atom.npz", states=all_states, actions=all_action_idx, rewards = all_rewards, masks = all_masks)
